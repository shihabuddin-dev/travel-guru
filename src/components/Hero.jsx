        ...
        <div className='container mx-auto px-4 md:px-8 lg:px-12 pt-4 md:pt-12 flex flex-col md:flex-row items-center gap-6'>
            ...
            <div className='flex gap-2 md:gap-4'>
                ...
                <div className='border-2 border-yellow-400 rounded-2xl'>
                    <img className='rounded-2xl w-48 h-40 md:h-76 object-cover opacity-75' src='/bg-img.png' alt="" />
                </div>
                <div className='border-2 border-yellow-400 rounded-2xl'>
                    <img className='rounded-2xl w-48 h-40 md:h-76 object-cover opacity-75' src={sajek} alt="" />
                </div>
                <div className='border-2 border-yellow-400 rounded-2xl'>
                    <img className='rounded-2xl w-48 h-40 md:h-76 object-cover opacity-75' src={srimongol} alt="" />
                </div>
            </div>
